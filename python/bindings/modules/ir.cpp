...
#undef BIND_UNARY_EXPR
  ...
  spmd_scope_stmt_class.def(nb::init<ExprPtr, bool, std::optional<Level>, std::string, const StmtPtr&,
                                     const Span&>(),
                            nb::arg("core_num"), nb::arg("sync_start") = false,
                            nb::arg("level") = nb::none(), nb::arg("name_hint") = "",
  ...
  spmd_scope_stmt_class.def(
      ...
      [](SpmdScopeStmt* self, int64_t core_num, bool sync_start, std::optional<Level> level,
         std::string name_hint, const StmtPtr& body, const Span& span) {
        auto core_num_expr = std::make_shared<const ConstInt>(core_num, DataType::INDEX, span);
        new (self) SpmdScopeStmt(core_num_expr, sync_start, level, std::move(name_hint), body, span);
      },
      nb::arg("core_num"), nb::arg("sync_start") = false, nb::arg("level") = nb::none(),
      nb::arg("name_hint") = "", nb::arg("body"),
