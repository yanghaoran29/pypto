...
| pto.tquant.mx | TQUANT (overload) | tile | ✅ | ✅ | ❌ | ✅ | — | A5 MXFP8/MXFP4 standalone quantization frontend+codegen+hardware ST (`group_axis` A/B); MXFP4 is `dtype=FP4` with FP16/BF16 sources and E8M0 scales |
