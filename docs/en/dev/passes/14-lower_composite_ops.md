...
On Ascend950, the public quant data and scale may feed `matmul_mx` in the same InCore mixed task. [ExpandMixedKernel](25-expand_mixed_kernel.md#mx-scale-v2c-transport) carries both results directly over V2C.
