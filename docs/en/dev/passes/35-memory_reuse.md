...
[`MaterializeSemanticAliases`](34-materialize_semantic_aliases.md) and before
[`AllocateMemoryAddr`](36-allocate_memory_addr.md). `MemoryPlanner.DSA_RP`
...
(see [InitMemRef](33-init_memref.md#declared-allocations)), and this pass then treats it as
