...
- [`CanonicalizeIOOrder`](32-canonicalize_io_order.md) — runs immediately before; produces the program state the materialization consumes
- [`InitMemRef`](34-init_memref.md) — first downstream consumer that depends on explicit stride
