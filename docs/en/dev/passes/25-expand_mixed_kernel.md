...
| Shape | Reported by |
| ----- | ----------- |
| A `pl.split_aiv` region | [`AivSplitValid`](99-verifier.md) check (l), with [`LowerAutoVectorSplit`](24-lower_auto_vector_split.md) as the backstop |
...
[`LowerAutoVectorSplit`](24-lower_auto_vector_split.md) (pass 23), so [`SplitVectorKernel`](27-split_vector_kernel.md)
...
[`LowerAutoVectorSplit`](24-lower_auto_vector_split.md) for the shared contract.
...
[LowerAutoVectorSplit](24-lower_auto_vector_split.md) rebalanced a ragged
...
derivation: [LowerAutoVectorSplit](24-lower_auto_vector_split.md).
