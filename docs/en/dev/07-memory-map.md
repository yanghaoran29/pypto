...
- `docs/en/dev/passes/36-allocate_memory_addr.md` — the pass whose output is mapped
- `docs/en/dev/passes/35-memory_reuse.md` — the pass that decides which lifetimes may share a slot
