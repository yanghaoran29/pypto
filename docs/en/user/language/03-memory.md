...
`Vec`) and [InferTileMemorySpace](../../dev/passes/21-infer_tile_memory_space.md) inserts
...
- [InferTileMemorySpace](../../dev/passes/21-infer_tile_memory_space.md) — the pass that inserts moves you did not write.
