...
`Vec`) and [InferTileMemorySpace](../../dev/passes/19-infer_tile_memory_space.md) inserts
...
[MemoryReuse](../../dev/passes/35-memory_reuse.md) and
[AllocateMemoryAddr](../../dev/passes/36-allocate_memory_addr.md); the performance chapter
...
- [InferTileMemorySpace](../../dev/passes/19-infer_tile_memory_space.md) — the pass that inserts moves you did not write.
- [MemoryReuse](../../dev/passes/35-memory_reuse.md) — how buffers are shared across lifetimes.
