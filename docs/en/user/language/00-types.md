...
contract does not consume this MXFP4 result directly. Even for MXFP8, `quant_mx` and
`matmul_mx` cannot currently share one InCore mixed task; place them in separate AIV/AIC
kernels and stage quantized data and scales through GM.
