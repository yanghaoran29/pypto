...
| [开发容器](04-dev-container.md) | 预构建的昇腾 A2/A3 镜像 —— 宿主机前置条件、拉取与运行、选卡，以及设备侧故障排查 |
...
| 主题 | 当前位置 |
| ---- | -------- |
| 混合 kernel（AIC + AIV 同一函数） | [LowerAutoVectorSplit](../dev/passes/24-lower_auto_vector_split.md)、[ExpandMixedKernel](../dev/passes/25-expand_mixed_kernel.md)、[TPUSH/TPOP](../reference/pto-isa/01-tpush_tpop.md) |
