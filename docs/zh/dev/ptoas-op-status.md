...
**PyPTO 当前源码**核实（最后更新 2026-08-13）。后续每加或修改一个 op，只更新本表对应行。
...
| pto.tquant.mx | TQUANT (overload) | tile | ✅ | ✅ | ❌ | ✅ | — | A5 MXFP8 与 MXFP4 独立量化前端+codegen+真机 ST；MXFP4 覆盖 FP16/BF16 和 MX_A_ZZ/MX_B_NN |
