...
在 Ascend950 上，公开的 quant data 与 scale 可以在同一个 InCore mixed task 内直接供 `matmul_mx` 使用；[ExpandMixedKernel](25-expand_mixed_kernel.md#mx-scale-的-v2c-传输) 会把两个结果直接经 V2C 传递。
