...
该检查在更早的 [`OutlineIncoreScopes`](10-outline_incore_scopes.md) 中执行，那里作用域自身
...
[`OutlineIncoreScopes`](10-outline_incore_scopes.md)（pass 9）保证，它会把外围的 `InCore`
scope 提取为独立函数。
...
- [`ResolveBackendOpLayouts`](23-resolve_backend_op_layouts.md) —— 紧邻其前运行。
